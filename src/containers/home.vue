<template>
  <div width="100vw" height="100vh">
    <svg
      xmlns="http://www.w3.org/2000/svg" width="100%" height="97%"
      @mouseup.left="mouseUp" @mousemove="mouseMove"
    >
      <g v-for="idea in ideas" :key="'arrow_' + idea.id">
        <line
          v-for="dep in idea.dependency" :key="'dep_' + dep" stroke="gray"
          :x1="idea.pos.cx" :y1="idea.pos.cy" :x2="getIdeaById(dep).pos.cx" :y2="getIdeaById(dep).pos.cy"
        />
      </g>
